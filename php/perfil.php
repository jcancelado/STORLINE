...
// Obtener el nombre del usuario y el rol de la sesión
...
$usuario = $_SESSION['NombreUsuario'];
$rol = isset($_SESSION['Rol']) ? $_SESSION['Rol'] : 0; // Establecer un valor predeterminado si el Rol no está definido
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <header>
        ...
        <?php
    // Mostrar opciones adicionales si el rol es igual a 3
    if ($rol == 3) {
        echo '<a href="ejecutar_script.php">CRUD</a>';
        echo '<a href="insertar/index.php">INSERTAR</a>';
